...
@WebServlet("/sports-group-names")
public class SportsProfilesDataServlet extends HttpServlet {

  @Override
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    Query query = new Query("SportsProfiles");
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    for(String pName: profileNameList){
        Entity sportsEntity = new Entity("SportsProfiles");
        sportsEntity.setProperty("Username", pName);
        datastore.put(sportsEntity);
    }
