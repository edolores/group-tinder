...
@WebServlet("/music-group-names")
public class MusicProfilesDataServlet extends HttpServlet {

  @Override
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    Query query = new Query("MusicProfiles");
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    for(String pName: profileNameList){
        Entity musicEntity = new Entity("MusicProfiles");
        musicEntity.setProperty("Username", pName);
        datastore.put(musicEntity);
    }

    // Redirect back to the chat page.
    response.sendRedirect("/music-chat.html");
  }
}
