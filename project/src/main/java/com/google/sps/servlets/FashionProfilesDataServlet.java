...
@WebServlet("/fashion-group-names")
public class FashionProfilesDataServlet extends HttpServlet {

  @Override
  public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
    Query query = new Query("FashionProfiles");
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
    ...
    for(String pName: profileNameList){
        Entity fashionEntity = new Entity("FashionProfiles");
        fashionEntity.setProperty("Username", pName);
        datastore.put(fashionEntity);
    }

    // Redirect back to the chat page.
    response.sendRedirect("/fashion-chat.html");
  }
}
